...
public class ApplicationDbContext(DbContextOptions<ApplicationDbContext> options) : DbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        //Aplicar snake case para tablas y columnas
        ...
        modelBuilder.Entity<User>(entity =>
        {
            ...
            entity.Property(e => e.UpdatedAt)
                .IsRequired();
            //Indices de optimizacion de busqueda
            ...
            entity.HasOne(e => e.UserEmail)
                .WithOne(ur => ur.User)
                .HasForeignKey<UserEmail>(ur => ur.UserId);
    ...
    private void UpdateTimestamps()
    {
        var entries = ChangeTracker.Entries()
            .Where(e => (e.Entity is User || e.Entity is Role || e.Entity is UserRole) && (e.State == EntityState.Added || e.State == EntityState.Modified));
